...
import 'task_dev_appro_list2_model.dart';
export 'task_dev_appro_list2_model.dart';

class TaskDevApproList2Widget extends StatefulWidget {
  const TaskDevApproList2Widget({Key? key}) : super(key: key);

  @override
  _TaskDevApproList2WidgetState createState() =>
      _TaskDevApproList2WidgetState();
}

class _TaskDevApproList2WidgetState extends State<TaskDevApproList2Widget>
    with TickerProviderStateMixin {
  late TaskDevApproList2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskDevApproList2Model());
                        ...
                        Expanded(
                          child: wrapWithModel(
                            ...
                            child: SlidbarNavWidget(
                              ...
                              bgDevapproval: Color(0xFFFFE051),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                                DevRemarkWidget(
                                                                              key: Key('Keyucv_${deviatIndex}_of_${deviat.length}'),
                                                                            ),
                                                                          ),
                                                                          Container(
                                                                            width:
                                                                              ...
                                                                              child: Builder(
                                                                                builder: (context) => FFButtonWidget(
                                                                                  onPressed: () async {
                                                                                    ...
                                                                                    if (FFAppState().DevRemark == null || FFAppState().DevRemark == '') {
                                                                                      await showDialog(
                                                                                        context: context,
                                                                                    ...
                                                                                    _model.approve = await TaskManagementGroup.taskApproveCall.call(
                                                                                      ...
                                                                                      pagevalue: '${getJsonField(
                                                                                        deviatItem,
                                                                                        r'''$.task_id''',
                                                                                      ).toString()}*${FFAppState().LoginID}*8*${FFAppState().DevRemark}',
                                                                                      paraVlalue: '0',
                                                                                      token: FFAppState().Token,
                                                                                    );
                                                                                    ...
                                                                                    await showDialog(
                                                                                      ...
                                                                                      builder: (alertDialogContext) {
                                                                                        return AlertDialog(
                                                                                          content: Text('Task Deviation Approved'),
                                                                                          actions: [
                                                                                            TextButton(
                                                                                              onPressed: () => Navigator.pop(alertDialogContext),
                                                                                              child: Text('Ok'),
                                                                                ...
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  _model.reject = await TaskManagementGroup.taskApproveCall.call(
                                                                                    ...
                                                                                    pagevalue: '${getJsonField(
                                                                                      deviatItem,
                                                                                      r'''$.task_id''',
                                                                                    ).toString()}*${FFAppState().LoginID}*9*${FFAppState().DevRemark}',
                                                                                    paraVlalue: '0',
                                                                                    token: FFAppState().Token,
                                                                                  );
                                                                                  _shouldSetState = true;
                                                                                  ...
                                                                                  await showDialog(
                                                                                    ...
                                                                                    builder: (alertDialogContext) {
                                                                                      return AlertDialog(
                                                                                        content: Text('Task Deviation Rejected'),
                                                                                        actions: [
                                                                                          TextButton(
                                                                                            onPressed: () => Navigator.pop(alertDialogContext),
                                                                                            child: Text('Ok'),

...
import 'deviationalert_model.dart';
export 'deviationalert_model.dart';

class DeviationalertWidget extends StatefulWidget {
  const DeviationalertWidget({Key? key}) : super(key: key);

  @override
  _DeviationalertWidgetState createState() => _DeviationalertWidgetState();
}

class _DeviationalertWidgetState extends State<DeviationalertWidget> {
  late DeviationalertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeviationalertModel());
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('TASKDEVIATION_Request');
                      },
                      text: 'OK',
